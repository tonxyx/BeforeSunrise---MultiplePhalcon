            ...
            if ($this->request->isPost()) {
                if ($this->getParam('id') != $oUser->getId()) {
                    ...
                    if ($oUser->save() === false) {
                        ...
                        return $this->response->redirect('/DitusCore/users/myaccount', true);
                    }

                }
            }
        } else {
            return $this->response->redirect('/DitusCore/users/login', true);
        }
                        ...
                        if (Users::hashPassword($sPassword) == $oRequestedUser->getPassword()) {
                            ...
                            if (Users::getCurrent())
                            {
                                if(Users::getCurrent()->getRole() == 1){
                                    $this->response->redirect('/DitusCore/admin/', true);
                                }
                            }
                            else{
